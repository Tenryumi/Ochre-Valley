...
#define ADMIN_PM(user) "(<a href='?_src_=holder;[HrefToken(TRUE)];priv_msg=[REF(user)]'>PM</a>)" //OV ADD
...
#define ADMIN_FULLMONTY_NONAME(user) "[ADMIN_QUE(user)] [ADMIN_PM(user)] [ADMIN_PP(user)] [ADMIN_VV(user)] [ADMIN_SM(user)] [ADMIN_FLW(user)] [ADMIN_TP(user)] [ADMIN_INDIVIDUALLOG(user)] [ADMIN_SMITE(user)]" //OV EDIT
