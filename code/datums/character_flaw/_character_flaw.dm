...
GLOBAL_LIST_INIT(character_flaws, list(
	...
	//Caustic edit
	/datum/charflaw/bottomless::name = /datum/charflaw/bottomless, // OV Edit : Stop using string names for key
	/datum/charflaw/mind_broken::name = /datum/charflaw/mind_broken, // OV Edit : Stop using string names for key
	//Caustic edit end
...
// Caustic Cove Edit start - Our rounds are now 4 hours long, so this has to cost a tiny bit more!
/datum/charflaw/noflaw
	name = "No Flaw (-4 TRI)" // Edit here
	desc = "I'm a normal person, how rare! (Consumes 4 triumphs or gives a random flaw.)" // Edit here
